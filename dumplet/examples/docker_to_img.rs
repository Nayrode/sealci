...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let args: Vec<String> =
        vec!["/home/hugo/Bureau/cours/rust_sor/sealci/dumplet/src/main.rs:/app/caca/test.rs".to_string()]; // Adjust as needed

    let bundle = generate_initramfs_image(image, env, args).await?;
